...
- [x] **WK-010: Advanced Focus Selection** - Implement the Focus Matrix in settings to allow targeting by level spreads, 'Most Recent', and 'Leeches'.
- [x] **WK-016: Bugfix - WKOF Detection** - Fixed detection issue using `unsafeWindow` (v0.2.1).

## To-Do Tasks (Ordered by Priority)

### High Priority
- [ ] **WK-018: Bugfix - WKOF Scan Hang** - Investigate and fix why the scanning status never clears; likely due to module initialization.
